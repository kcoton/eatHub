...
INSERT INTO Version (recipeID, versionID, instructions, versionDate, versionServing, calories) VALUES (3, 6, 'For a crunchy texture, top the finished dish with roasted cashews or almonds just before serving.', TO_DATE('2023-10-20', 'YYYY-MM-DD'), 4, 360);
INSERT INTO Version (recipeID, versionID, instructions, versionDate, versionServing, calories) VALUES (3, 7, 'Boost the nutritional value by incorporating a mix of kale and spinach into the stir-fry during the last two minutes of cooking.', TO_DATE('2023-10-20', 'YYYY-MM-DD'), 4, 360);
